    ...
    <section className="w-full bg-[#151C39]  grid grid-cols-3 space-x-3 px-5 py-2 overflow-y-auto h-screen">
      <div className="col-span-2  rounded-2xl grid grid-rows-5 space-y-4 px-2  py-2">
        <div className="row-span-1 rounded-xl  flex items-center justify-around">
          <h1 className="text-3xl font-bold text-[#FFFFFF]">{greetings} 👋</h1>
          <div className="flex items-center justify-center gap-1">
            <div className="relative px-3 bg-[#2C3A58] rounded-xl text-sm text-[#CCCCCC]">
              ...
              <input type="text" id="search" value={'Search'} placeholder="Search" className="w-96 px-6 py-3 bg-[#2C3A58]  border-none rounded focus:outline-none" />
            </div>
            <div className="relative">
              <button className="p-3 bg-[#409BEE] rounded-xl text-xl text-white ">
      ...
      <div className="col-span-1 bg-[#111729] rounded-2xl grid grid-rows-6 py-6 px-6 h-fit">
        <div className="row-span-2  flex flex-col items-center justify-center gap-2 text-white m-2">
          <Image src="/user.png" width={100} height={100} className="rounded-full bg-gray-50" alt="" />
        ...
        <div className="row-span-1  rounded-xl flex items-center justify-around m-2 bg-[#1C2A4E] py-4 px-2 ">
          <div className="flex  items-center gap-4 rounded-2xl">
            ...
            <div className="flex -space-x-4 rtl:space-x-reverse items-center justify-center">
              <Image src={`/patient${1}.png`} width={40} height={40} className="border h-10 w-10 border-white rounded-full bg-[#E8BBF8]" alt="" />
              <Image src={`/patient${2}.png`} width={40} height={40} className="border h-10 w-10 border-white rounded-full bg-[#BBF8F1]" alt="" />
              <Image src={`/patient${3}.png`} width={40} height={40} className="border h-10 w-10 border-white rounded-full bg-[#CBF8BB]" alt="" />

              <a href="#" className="w-11 h-11 p-2 bg-[#CCCCCC] border border-black text-black rounded-full flex items-center justify-center">
                +8
              </a>
            </div>
          </div>
