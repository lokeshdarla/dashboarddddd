  ...
  return (
    <div className=' flex flex-col items-center justify-start gap-0 '>
      ...
      <Image src={'/chat1.png'} alt='sender photo' width={45} height={45} className='bg-[#E8F8BB] rounded-full' />
        <div className=' flex flex-col items-start justify-center px-4 mr-8 text-xs gap-3 py-3'>
          <p className='bg-[#BDD8F0] px-3 py-2 rounded-xl'>Hi, Alexa.</p>
          <p className='bg-[#BDD8F0] px-3 py-2 rounded-xl'>I got knee jerk. What
should i do right now?</p>
      ...
      <div className='flex items-start justify-center gap-2'>
        <div className=' flex flex-col items-end justify-center px-2 text-xs gap-3 py-3'>
          ...
          <p className='bg-[#BDD8F0] px-3 py-2 rounded-xl '>This help maintain balance and posture.</p>
          <p className='text-[#CCCCCC] text-xs'>tue 02:32pm</p>
        </div>
